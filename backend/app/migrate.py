...
NEW_COLUMNS: list[tuple[str, str, str]] = [
    ...
    ("employees", "gosi_subscribed", "BOOLEAN DEFAULT 0"),
    ("employees", "is_saudi", "BOOLEAN DEFAULT 0"),
    ("payslips", "payable_days", "FLOAT DEFAULT 0"),
    ("payslips", "gosi_base", "FLOAT DEFAULT 0"),
    ("payslips", "gosi_employee", "FLOAT DEFAULT 0"),
    ("payslips", "gosi_employer", "FLOAT DEFAULT 0"),
